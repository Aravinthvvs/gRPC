...
type TicketServiceClient interface {
	...
	ViewUsersBySection(ctx context.Context, in *ViewUsersRequest, opts ...grpc.CallOption) (*ViewUsersResponse, error)
...
func (c *ticketServiceClient) PurchaseTicket(ctx context.Context, in *PurchaseRequest, opts ...grpc.CallOption) (*PurchaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/TicketService/PurchaseTicket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketServiceClient) GetReceipt(ctx context.Context, in *ReceiptRequest, opts ...grpc.CallOption) (*ReceiptResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/TicketService/GetReceipt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketServiceClient) ViewUsersBySection(ctx context.Context, in *ViewUsersRequest, opts ...grpc.CallOption) (*ViewUsersResponse, error) {
	out := new(ViewUsersResponse)
	err := c.cc.Invoke(ctx, "/TicketService/ViewUsersBySection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketServiceClient) RemoveUser(ctx context.Context, in *RemoveUserRequest, opts ...grpc.CallOption) (*RemoveUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/TicketService/RemoveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketServiceClient) ModifySeat(ctx context.Context, in *ModifySeatRequest, opts ...grpc.CallOption) (*ModifySeatResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/TicketService/ModifySeat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TicketServiceServer interface {
	...
	ViewUsersBySection(context.Context, *ViewUsersRequest) (*ViewUsersResponse, error)
...
func (UnimplementedTicketServiceServer) ViewUsersBySection(context.Context, *ViewUsersRequest) (*ViewUsersResponse, error) {
...
func _TicketService_PurchaseTicket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TicketService/PurchaseTicket",
	}
...
func _TicketService_GetReceipt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TicketService/GetReceipt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TicketService_ViewUsersBySection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TicketService/ViewUsersBySection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TicketServiceServer).ViewUsersBySection(ctx, req.(*ViewUsersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TicketService_RemoveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TicketService/RemoveUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TicketService_ModifySeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/TicketService/ModifySeat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
